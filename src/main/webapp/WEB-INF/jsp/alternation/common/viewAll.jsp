...
function DateHandle(obj) {  
	...
	function pass(flag){
		...
		if(flag){
			...
			comment=comment2;
			$.post(
					"${ctx}/alternation/saveComment.action",
					"taskId="+taskId+"&comment="+comment,
					function(data){
						location.href="${ctx}/alternation/expressMessage/toSendMessage.action"
					}
				);
		}
	}
               ...
               <section class="panel" style="height:90%">
                  <div class="panel-body" style="height:100%">
                     <div class="adv-table editable-table" style="height:100%">
                        ...
                        <iframe id="info" style="min-height: 70%;" src="" frameborder="0" width="100%" leftmargin="0" topmargin="0"></iframe>
                       </div>
                        ...
                        <div class="panel-body">
                           ...
                           <div class="form-group" id="isPass">
                            	<div class="col-sm-2 text-right">
			                            ...
			                            <div class="col-sm-10">
			                            	<textarea rows="" cols="" id="passComment2" class="form-control" >经分中心审批，允许变更。</textarea>
			                            </div>
                           </div>

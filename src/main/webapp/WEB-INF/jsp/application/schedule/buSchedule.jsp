...
<section class="panel" style="margin-bottom:0px">
                 <div class="panel-body">
                  ...
                  用户：<span style="color:#54B6D1">${activeUser.realname}</span>的申请进度
      ...
      <div id="business" style="margin-bottom: -20px">
         <span style="margin-left: -3%">申请中</span>
         <span style="margin-left: 5%">初审中</span>
	     <span style="margin-left: 6%">初审通过</span>
	     <span style="margin-left: 6%">评审中</span>
	     <span style="margin-left: 4%">评审通过</span>
	     <span style="margin-left: 3%">中心审核中</span>
	     <span style="margin-left: 1%">中心审核通过</span>
	     <span style="margin-left: 1%">中心复核中</span>

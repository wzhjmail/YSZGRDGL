...
function view(){
	if(selectId==null){
		...
		location.href = "${ctx}/application/edit.action?id="+selectId+"&taskId="+taskId1;
	}
}
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">分支机构初审个人任务</h4>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">初审任务</h4>
              </div>
              <div class="modal-body">
              	<p><center>分支机构初审意见</center></p>

...
<script src="${ctx}/js/style_self.js"></script>	<link rel="stylesheet" href="${ctx}/css/validationEngine.jquery.css">
		...
		function(){
			if(nRow==null){
				...
				var taskId=$("#result").children("tr").eq(nRow).children("td").eq(0).text();
	     		window.location.href="${ctx}/recognition/review/toReviewForm?taskId="+taskId;
		}}	
	);
...
// 		location.href = "${ctx}/application/view.action?id="+selectId
		window.open("${ctx}/application/toViewReApply.action?titleNo="+selectNo+"&id="+selectId+"&taskId="+taskId1)
	}
}
...
<!--                                  <th class="">到期日期</th> -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">分支机构评审任务</h4>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="forms" method="post" action="${ctx}/recognition/review/applyReview.action" enctype="multipart/form-data">
              <div class="modal-body">

			...
			$.each(data,function(i,item){
				$("#result").append("<tr>"
						...
						+"<td class=''>"+exchangeNull(item.titleno)+"</td>"
		             	...
		             	+"<td class=''>"+(item.status==17?"分中心退回":"中心退回")+"</td>"
...
// 		             	+"<td class=''><a href='${ctx}/common/downPdf.action?type=5&titleNo="+item.titleno+"' class='btn btn-success green'>评审表下载</a></td>"
		             	+"<td class=''><button class='btn btn-success green' data-toggle='modal' href='#Modal_show1'>初审</button></td></tr>");
			});
		}
	);
});//初始化

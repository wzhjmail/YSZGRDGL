...
function DateHandle(obj) {  
	...
	function pass(flag){
		...
		if(!$("#passbox").attr("checked")&&!$("#notpassbox").attr("checked")){
			...
			$.post(
		       		...
		       		$.post(
					"${ctx}/recognition/review/completeTask.action",
					"taskId="+taskId+"&result="+flag+"&comment=''",
					function(data){
						location.href='${ctx}/recognition/expressMessage/toTasks.action';
							}
						);
		       			}else{
...
<body style="height:100%;overflow-y: hidden;">
	...
	<script src="${ctx}/js/editable-table.js" ></script> <!--EDITABLE TABLE JS  -->
     ...
     function goBack(){
    	 window.location.href="${ctx}/recognition/expressMessage/toTasks.action"
     }

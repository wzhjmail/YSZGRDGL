                        ...
                        <div class="panel-body">
                           <form class="form-horizontal tasi-form" method="get">
                              <div class="form-group">
                                 <label class="col-sm-1 col-sm-1 control-label">企业名称</label>
                                 <div class="col-sm-6">
                              ...
                              <div class="form-group">
                                 <label class="col-sm-1 col-sm-1 control-label">详细地址</label>
                                 <div class="col-sm-6">
                                    <input type="text" class="form-control">
                                 </div>
							  ...
							  <div class="form-group">
                                 <label class="col-sm-1 col-sm-1 control-label">营业执照号码</label>
                                 <div class="col-sm-3">
                                    <input type="text" class="form-control">
                                 </div>
								 ...
								 <label class="col-sm-1 col-sm-1 control-label">注册资本</label>
                                 <div class="col-sm-3">
                                    <input type="text" class="form-control">
                                 </div>
                              </div>
							  <div class="form-group">
								 ...
								 <label class="col-sm-1 col-sm-1 control-label">职务</label>
                                 <div class="col-sm-3">
                                    <input type="text" class="form-control">
                                 </div>
								 <label class="col-sm-1 col-sm-1 control-label">电话</label>
                                 <div class="col-sm-3">
                                    <input type="text" class="form-control">
                                 </div>
                              </div>
                     ...
                     <section class="panel">
                        ...
                        <div class="panel-body">
						   ...
						   <div class="form-group">
                             ...
                             <div class="col-lg-10">
                                  <textarea class="form-control" rows="12" id="ccomment" name="comment"></textarea>
                             </div>  
                           </div> 						 
                           </form>
                        </div>
                     ...
                     <section class="panel">
                        ...
                        <div class="panel-body">
						   ...
						   <div class="form-group">
                             <div class="col-lg-1"></div>
                             <div class="col-lg-10">
                                  <textarea class="form-control" rows="8" id="ccomment" name="comment"></textarea>
                             </div>  
                           </div> 						 
                           </form>
                        </div>

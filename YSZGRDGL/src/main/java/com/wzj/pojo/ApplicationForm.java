...
public class ApplicationForm {
    ...
    private Date certtodate;//到期日期
    private Date createdate;//创建时间
    private Integer isrepeat;//
    private Integer status;//状态//1是已发证，0是未发证
    ...
    private MultipartFile quality;//质量手册
    private String branchId;//分支机构id
    private int companyId;//公司基本信息表的id
    private String taskId;//任务Id 
    private String branchName;//分支机构名称
    private int qualityno;//质量手册号码
    private int certNo;//证书编号
    private String appFileName;//申请表名称
	...
	public MultipartFile getBusiness() {
		return business;
	}
	public void setBusiness(MultipartFile business) {

	...
	function pass(flag){
		if ($('#passform').validationEngine('validate')) {
			...
			if(flag){
				...
				comment=comment2;
				$.post(
					"${ctx}/recognition/expressMessage/saveComment.action",
				...
				$.post(
						"${ctx}/recognition/expressMessage/goBack.action",
...
<body style="height:100%">
                     ...
                     <section class="panel">
                        ...
                        <form id="passform">
                           ...
                           <div class="form-group text-center">
                            <div class="btn-group">
                              <input type="button" class="btn-info  btn" onclick="goBack()" value="返回">
                            </div>
                            <div class="btn-group">
	...
	<script src="${ctx}/js/editable-table.js" ></script> <!--EDITABLE TABLE JS  -->
     ...
     function goBack(){
    	 window.location.href="${ctx}/recognition/expressMessage/toSendMessage.action"
     }
     </script>
</body>
</html>
...
// 			             	+"<td></td>"
	...
	function checkBusiness(){
		if(selectId==null){
			...
			$("#onGoing").attr("src","${ctx}/recognition/business/view.action?id="+selectId);
		}
	}
</script>
</head>
          ...
          <div class="modal-dialog">
            <div class="modal-content" style="height: 600px;width:150%;margin-left: -25%;">
              <div class="modal-header">
                ...
                <h4 class="modal-title">复认业务进度</h4>
              </div>
        ...
        function addall(status){
            ...
            $('#editable-sample_wrapper .col-sm-4:last').addClass('col-lg-6').removeClass('col-sm-4')
 			var str = '<div class="col-sm-4" style="padding:15px 0"><lable> 业务进度查询：</lable><select id="all" onchange="change()">'+
            		'<option value="all">全部</option><option value="18">复认申请中</option>'+
            		'<option value="19">复认申请退回</option><option value="20">业务受理中</option>'+
					'<option value="21">业务受理退回</option><option value="22">现场评审中</option>'+
					'<option value="23">现场评审退回</option>'+
					'<option value="24">录取样品信息中</option><option value="25">录取样品信息退回</option>'+
					'<option value="26">上传检验报告中</option><option value="27">上传检验报告退回</option>'+
					'<option value="28">分中心审批中</option><option value="30">分中心审批退回</option>'+
					'<option value="29">中心核准中</option><option value="32">中心核准退回</option>'+
					'<option value="31">中心批准中</option><option value="33">复用证书号</option></select></div>'

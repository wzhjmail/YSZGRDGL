		...
		<div id="Modal_show" class="modal fade">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
              	<p><center>出具检验报告</center></p>
                <textarea id="comment" autocomplete="off" class="form-control placeholder-no-fix" value=""></textarea>
	         </div>
     ...
     <script>
        ...
        function processTask(result){//初审任务的处理
            ...
            $.post(
            	...
            	"taskId="+taskId+"&comment="+comment+"&role=中心复核人员&candidate=bmzx"

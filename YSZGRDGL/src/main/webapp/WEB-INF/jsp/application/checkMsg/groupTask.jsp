	...
	$("#psb").click(
		function(){
			if(nRow==null){
				...
				wzj.confirm('温馨提示','您确定拾取该任务？',function(flag){
...
function getTasks(){
	...
	$.post(
		"${ctx}/application/expressMessage/getGroupTasks.action",
		"pointName=编码中心查看材料&status=5",
		function(data){
                     ...
                     <div class="adv-table editable-table">
                        <div class="clearfix">
                         <div class="btn-group col-lg-1 nopaddingleft">
                              <button onclick="view();" class="btn btn-info" data-toggle='modal' id="dialog">
                            	  查看 <i class="fa fa-eye"></i>
                              </button>
                           </div>
                           <div class="btn-group col-lg-1">
                              <button onclick="show();" class="btn btn-info" data-toggle='modal' id="dialog1">

			...
			$.each(data,function(i,item){
				...
				result+="style='color:red'"
						...
						+"<td class=''>"+item.enterprisename+"</td>"
		             	...
		             	+"<td class='' style='display:none'>"+item.branchId+"</td></tr>";
...
function viewReview(){
	if(nRow==null){
		...
		window.open("${ctx}/application/toViewPS.action?titleNo="+selectNo+"&taskId="+taskId);
	}
}
//盖章申请表下载
function saveSQ(){
...
function viewInfo(){
	if(nRow==null){
		...
		location.href='${ctx}/application/expressMessage/viewAll.action?titleNo='+selectNo+'&appId='+selectId+'&taskId='+taskId+'&comName='+comName;	
	}
}
//打印
function print(){
                        ...
                        <div class="clearfix">
                           <div class="btn-group  nopaddingleft">
                              <button onclick="viewInfo()" class="btn btn-info" data-toggle='modal' href=''>
                            	 审批 <i class="fa fa-book"></i>
                              </button>
                           </div>
                           <div class="btn-group ">
                              <button onclick="setName()" class="btn btn-info" data-toggle='modal' href='' id="send">
...
<!-- 				</div> -->
	         ...
	         <div class="modal-footer" style="margin-top:0px;">
                ...
                <button class="btn btn-success" id="yesbtn" type="button" onclick="msgAdd()">
                 	确定
                </button>
              </div>
              </div>
     ...
     <script>
        ...
        function msgAdd(){
        	if($('#msg').validationEngine('validate')){
		        	...
		        	$("#msg").attr("action","${ctx}/application/expressMessage/insertExpress.action?taskId="+taskId);
					$("#msg").submit();
        ...
        function back(){
        	...
        	$.post(
               	...
               	"taskId="+taskId+"&comment="+comment+"&role=分中心审核人员&candidate=fzjg"
               		+"&result=false&status=6",
               	function(data){

	...
	$("#pass1").click(function(e){
		...
		if(!(p1||p2)){
			...
			$.post(
		       		...
		       		"titleNo="+$("#titleNo").val()+"&UpDescribe=中心检测报告&sampleIds="+$("#sampleIds").val(),
		       		function(data){
		       			if(data.result=="true"){
		       				if($('#comment').val()==""){
...
function showSample(){
	...
	$("#editable-msg").attr("style","display:none");
	$("#editable-sample_wrapper").attr("style","display:none");
	$("#info").attr("src","${ctx}/pbtSample/toFRsampleHZ.action?comName="+comName+"&titleNo="+titleNo);
}
//意见
function getComment(){
	$('#btn .btn-info').removeClass('btn-info').addClass('btn-default')
...
function getMessage(){
	$('#btn .btn-info').removeClass('btn-info').addClass('btn-default')
	$('#msg').removeClass('btn-default').addClass('btn-info')
	$("#iframe").css("display","none");
	$("#editable-msg").attr("style","width:100%;");
	$("#editable-sample_wrapper").attr("style","display:none");
	$.post(
...
function DateHandle(obj) {  
	...
	//提交
	function pass(flag){
	var comment=$("#passComment2").val();
	$.post(
			"${ctx}/application/review/completeTask.action",
			"taskId="+taskId+"&result="+flag+"&comment="+comment,
			function(data){
				location.href="${ctx}/application/expressMessage/toPersonalTask.action"
			}
		);
	}
...
<body style="height:100%">
                  ...
                  <div class="panel-body" style="height:100%">
                     <div class="adv-table editable-table" style="height:100%">
                        ...
                        <div class="btn-group">
                           ...
                           <div class="btn-group ">
                              <button id="msg" class="btn btn-default" onClick='getMessage()' data-toggle='modal' href=''>
                            	  寄送信息<i class="fa fa-comment"></i>
                              </button>
                           </div>
                        ...
                        <input type="hidden" value="${sampleIds}" id="sampleIds">
                       ...
                       <table class="table table-bordered" style="width:100%;display:none;" id="editable-sample">
                        ...
                        <table class="table table-bordered" style="width:100%;display:none;" id="editable-msg">
                           <thead>
                              <tr>
                                 <th class="">快递名</th>
                                 <th class="">单号</th>
                     ...
                     <section class="panel">
                        <div class="panel-body ">
						   ...
						   <div class="form-group">
                             ...
                             <div class="col-sm-2">
                             	<input type="radio" id="passbox" name="isPass" onclick="clickbox(true)">通过
                             </div>
                             <div class="col-sm-2">
                                <input type="radio" id="notpassbox" name="isPass" onclick="clickbox(false)">不通过
                             </div> 
                           </div> 
                           <div class="form-group" id="isPass">
                            	<div class="col-sm-2 text-right">
			                            ...
			                            <div class="col-sm-8">
			                            	<textarea rows="" cols="" id="passComment2" class="form-control" ></textarea>
                          ...
                          <!--  <div class="form-group" id="isNotPass" style="display: none;">
		                     <div class="col-sm-2 text-right">
			                            ...
			                            <div class="col-sm-8">
			                            	<textarea rows="" cols="" id="notpassComment2" class="form-control"></textarea>
                            ...
                            <div class="btn-group">
                               <input type="button" id="pass1" class="btn-success  btn" value="提交">
                               <input type="button" id="pass2" style="display:none" class="btn-success  btn" value="提交">
                            </div>
                          </div> 
                           </span>
                        </div>
	...
	<script src="${ctx}/js/editable-table.js" ></script> <!--EDITABLE TABLE JS  -->
     ...
     function goBack(){
    	 window.location.href="${ctx}/application/expressMessage/toPersonalTask.action"
     }
